...
const Sell = require('./routes/new_sell/newSell');
const Selling = require('./routes/selling/selling');
...
MainRouter.use('/new-sell', Sell.SellRouter);
MainRouter.use('/selling', Selling.SellingRouter);
